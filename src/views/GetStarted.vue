<template>
  <div>
    <CAlert color="danger">
      <p>
        ⚠️ Gambling is gambling no matter what you do or how good your strategy
        is. The dealer always wins if you keep playing. Winners always know
        when to stop
      </p>

      <p>
        ⚠️ Like any human, many mistakes, and like any program, the bot is
    ...
    <CRow class="mb-4">
      ...
      <CCol xs="6" md="4" class="mb-4">
        <CCard color="success" class="text-center text-white">
          <CCardBody>
            <h1 class="p-4">🤖</h1>
            <h3>Make Interface</h3>
            <hr />
            <p>
              Bot interface maked directly on dice sites after you install
            </p>
          </CCardBody>
        </CCard>
      </CCol>
      ...
      <CCol xs="6" md="4" class="mb-4">
        <CCard color="warning" class="text-center text-white">
          <CCardBody>
            <h1 class="p-4">📄</h1>
            <h3>Read Script</h3>
            <hr />
      ...
      <CCol md="4">
        <CCard color="info" class="text-center text-white">
          <CCardBody>
            <h1 class="p-4">📈</h1>
            <h3>Auto Betting</h3>
            <hr />
...
6. Security enhancement (strong password, 2FA, etc..) for your accounts at all dice sites</pre>
          </CCardBody>
        </CCard>
      </CCol>
    </CRow>
        ...
        <CCard>
          <CCardBody>
            ...
            <p>
              ...
              <br />
              👉 Your dice script must clean, please follow syntax of programming
              language
              <br />
    ...
    <CRow class="mb-4">
      <CCol sm="12">
        <h4 class="p-4 text-center">
          <strong>Advice for safer gambling</strong>
        </h4>
      </CCol>

      <CCol sm="6" class="mb-4">
        <CCard color="success" class="text-white">
          <CCardBody>
            <h3>Set a money limit</h3>
            <hr />
            <p>
              Before betting, decide how much you can afford to lose. Setting a limit on the gambling company’s
              website can help
            </p>
          </CCardBody>
        </CCard>
      ...
      <CCol sm="6" class="mb-4">
        <CCard color="warning" class="text-white">
          <CCardBody>
            <h3>Set a time limit</h3>
            <hr />
            <p>
              It's easy to lose track of time when you're gambling. Set an alarm, and when time's up, focus on other
              things
            </p>
          </CCardBody>
        </CCard>
      ...
      <CCol sm="6" class="mb-4">
        <CCard color="info" class="text-white">
          <CCardBody>
            <h3>Walk away from losses</h3>
            <hr />
            <p>
              Like your team, ‘you win some, you lose some’. If you’ve lost the money limit you’d set yourself, it’s
              time to walk away
            </p>
          </CCardBody>
        </CCard>
      ...
      <CCol sm="6">
        <CCard color="danger" class="text-white">
          <CCardBody>
            <h3>Be aware of how you're feeling</h3>
            <hr />
            <p>
        ...
        <CCard>
          <CCardBody>
            <p>
              ...
              <a href="https://bitvest.io/?r=134231" target="_blank">
                bitvest.io,
              </a>
              ...
              <a href="https://duckdice.io" target="_blank"> duckdice.io, </a>
              <a href="https://faucetpay.io/?r=2102948" target="_blank">
                faucetpay.io,
              </a>
              ...
              <a href="https://megaplay.io/?c=ZNae4ChvlSSADkGsIxFf" target="_blank">
                megaplay.io,
              </a>
              <a href="https://nanogames.io/i-f0810ew-n/" target="_blank">
                nanogames.io,
              </a>
              <a href="https://paradice.in/?c=@mhqb365" target="_blank">
                paradice.in,
              </a>
              <a href="https://pasino.com/?user_id=41111" target="_blank">
                pasino.com,
              </a>
              <a href="https://primedice.com/?c=3e6d33fce7" target="_blank">
                primedice.com,
              </a>
              <a href="https://punt.com/?aid=1949" target="_blank"> punt.com, </a>
              ...
              <a href="https://wintomato.com/en/registration/1604" target="_blank">
                wintomato.com,
              </a>
...
export default {
  ...
  components: { CCol, CCard, CCardBody }
}
</script>
